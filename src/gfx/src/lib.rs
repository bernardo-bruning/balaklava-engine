...
impl balaklava_gpu::Device for GfxDevice {
    ...
    fn create_vertex_buffer(&mut self, _: &mut Self::Program, _: Vec<Vector>, _: Option<Vec<Vector>>) -> Self::Buffer {
        unimplemented!();
    }
    ...
    fn render_program(&mut self, program: &Program, _buffer: &Buffer, _transform: Option<Transform>, _texture: Option<&Self::Texture>) {
